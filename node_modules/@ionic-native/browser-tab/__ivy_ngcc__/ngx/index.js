...
BrowserTab.ɵfac = /*@__PURE__*/ function () { var ɵBrowserTab_BaseFactory; return function BrowserTab_Factory(t) { return (ɵBrowserTab_BaseFactory || (ɵBrowserTab_BaseFactory = ɵngcc0.ɵɵgetInheritedFactory(BrowserTab)))(t || BrowserTab); }; }();
BrowserTab.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: BrowserTab, factory: function (t) { return BrowserTab.ɵfac(t); } });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(BrowserTab, [{
        type: Injectable
    }], null, null); })();
    return BrowserTab;
}(IonicNativePlugin));
